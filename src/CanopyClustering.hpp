...
class CanopyClusteringAlg{
    public:
        ...
        static Canopy* create_canopy(Point* origin, boost::unordered_set<Point*>& marked_points, vector<pair<Point*,bool> >& points, double min_neighbour_correlation, double min_close_correlation, bool sets_close_points);
